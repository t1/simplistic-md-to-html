...
class SimplisticMarkDownToHtmlTest {
    companion object {
    ...
    fun shouldConvertFromFileWithImageMappings() {
        ...
        val converter = SimplisticMarkDownToHtml(readme)
    ...
    private fun shouldConvert(pair: Pair<String, String>) {
        val converter = SimplisticMarkDownToHtml(pair.first)
        init(converter)
    ...
    private fun init(converter: SimplisticMarkDownToHtml) {
    ...
    private fun withImageMapping(mapping: Pair<Pair<String, String>, String>): SimplisticMarkDownToHtmlTest {
